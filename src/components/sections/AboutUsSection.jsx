...
import AboutUsImage from "../../assets/sections/AboutUs.jpg";
...
const AboutUsSection = () => {
    ...
    return (
        <div
            className={`flex  flex-col md:flex-row bg-gray-100 overflow-hidden  items-center justify-between gap-8 px-6 py-12 md:px-12 lg:px-28 font-english 
