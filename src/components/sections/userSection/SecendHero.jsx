    ...
    return (
        <div className='pt-2 bg-gray-100'>
            ...
            >
                ...
                <div className=" xl:mt-8 w-full  md:w-2/3 overflow-hidden flex flex-col gap-6 justify-start items-center">
                    <motion.img
                    ...
                    <div className='flex flex-col gap-4 mb-8'>
                        <motion.h1
                            ...
                            className='text-5xl xl:text-6xl font-bold leading-relaxed'
                        >
                        ...
                        <motion.h2
                            ...
                            initial={{ x: -150, opacity: 0 }}
                            transition={{ duration: 0.9 }}
                            className='text-3xl xl:text-4xl xl:mt-4  font-semibold text-secondary'
                        >
